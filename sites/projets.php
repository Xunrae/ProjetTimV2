...
<section>
	...
	<div class="projet" title="Cliquez pour afficher la description">
		...
		<div class="description">
			<h2>Elementaris</h2>
			<p>Réalisé par des étudiants de 3ème année, dans le cadre du cours de Développement de Jeu. Elementaris est un "tower defense" où les tourelles sont basées sur les 4 éléments (eau,air,terre,feu). Elles ont des effets correspondants : le feu brûle, la glace ralentit,etc. Le but est de se débarasser des vagues d'ennemis, de manière à les annihiler COMPLÈTEMENT.</p>
		</div>
	</div>
	<div class="projet" title="Cliquez pour afficher la description">
	...
	<div class="projet" title="Cliquez pour afficher la description">
		...
		<div class="description">
			<h2>Quiz-O-Matic, Antoine L'Écuyer</h2>
			<p>Projet Web réalisé par un étudiant de 1ère année. Ce quiz interactif comporte des questions sur les jeux vidéos, des années 2000 à aujourd'hui. </p>
		</div>
	</div>
	<div class="projet" title="Cliquez pour afficher la description">
		<video src="../videos/QuercusFootage.mp4" muted autoplay loop preload="auto" ></video>
		<div class="description">
			...
			<p>Project Beast est un platformer 2D dont le but est de tuer les ennemis sans mourir pour arriver à la fin du niveau. </p>
		</div>
	</div>
